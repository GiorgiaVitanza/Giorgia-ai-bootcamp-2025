...
try:
    while True:
        with open(
            "Giorgia-ai-bootcamp-2025\python\giorno7\ex1\HighScore.csv", "r", newline=""
        ) as fd2:
        ...
        if x == x_ok:
            ...
            if attempts == high_score:
                ...
                list_high_score.append(
                    [name_winner, int(high_score), f"Date: {datetime.datetime.now()}"]
                )
            ...
            if decision != "sì" and decision != "no":
                ...
                name = sorted_csv(
                    "Giorgia-ai-bootcamp-2025\python\giorno7\ex1\HighScore.csv",
                    list_high_score,
                )
